...
const PRESETS = [
  ...
  "제23조(임직원간 상호존중 및 갑질 등 직장 내 괴롭힘 금지) 임직원은 상호 존중하는 직장 분위기 조성을 위해 노력해야 하며, 직위, 업무상 지위 또는 다수의 우월성을 이용하여 다른 임직원의 신체적, 정신적 건강을 훼손하거나 인격을 침해하는 다음 각 호의 행위를 하여서는 아니 된다."
];
